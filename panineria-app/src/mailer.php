 ...
 * Ritorna true in caso di successo, stringa di errore altrimenti.
 */
...
function buildEmailHtml(string $name, string $code): string {
    ...
    $codeDisplay = substr($code, 0, 3) . ' ' . substr($code, 3);
    return <<<HTML
    <!DOCTYPE html>
    <html lang="it">
          ...
          <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
            ...
            <tr>
              <td style="background:#b45309;padding:32px;text-align:center;">
                ...
                <h1 style="margin:8px 0 0;color:#ffffff;font-size:22px;font-weight:700;">Panineria</h1>
              </td>
            </tr>
            <!-- Body -->
            <tr>
              <td style="padding:36px 40px;">
                ...
                <div style="background:#fffbeb;border:2px dashed #f59e0b;border-radius:12px;padding:24px;text-align:center;margin-bottom:28px;">
                  ...
                  <p style="margin:0;font-size:42px;font-weight:800;color:#b45309;letter-spacing:8px;">{$codeDisplay}</p>
                </div>
                <p style="margin:0;font-size:13px;color:#9ca3af;line-height:1.5;">
                  Se non hai creato un account su Panineria, ignora questa email.
                </p>
              </td>
            </tr>
            <!-- Footer -->
