...
function renderCategories(activeCategory) {
    ...
    tuttiBtn.className = activeCategory === null ? ACTIVE_BTN : INACTIVE_BTN;
    tuttiBtn.onclick = () => { renderCategories(null); renderProducts(allProducts); };
    el.appendChild(tuttiBtn);
...
function getCategoryEmoji(cat) {
    const map = { 'Panini': '🥖', 'Burger': '🍔', 'Sandwich': '🥪', 'Piadine': '🫓', 'Bevande': '🥤', 'Sfiziosita': '🍟' };
    return map[cat] || '🍽️';
}
